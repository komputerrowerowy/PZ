...
private final int CHECK_CODE = 0x1;
    ...
    private void setupRecognizer() throws IOException {
        ...
        recognizer = SpeechRecognizerSetup.defaultSetup()
                .setAcousticModel(new File(mPath, "en-us-jj"))
                .setDictionary(new File(mPath, "0409.dic"))

                //.setRawLogDir(mPath) // To disable logging of raw audio comment out this call (takes a lot of space on the device)
