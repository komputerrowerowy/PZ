...
source.include_exts = py,png,jpg,kv,atlas,en-us-jj,0409.dic
...
requirements = kivy,futures,openssl,requests,plyer,osmapi,pyjnius,geocoder,sqlite3,pocketsphinx
